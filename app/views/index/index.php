...
<div class="container">
    ...
    <div class="col-md-8 chat">
        ...
        <div class="footer">
            ...
            <textarea name="" class="form-control type_msg  text" placeholder="... Type your message"
                      id="message"></textarea>
...
<div id="modalChange">
    <div class="content">
        <form onsubmit="return false">
            ...
            <button type="submit" id="changeName" class="contact">change name</button>
            <br>
...
// ------------------->>>>>>>>>>>
                    ...
                    $(document).on("contextmenu", "#msg-card_body", function (e) {
                        ...
                        if (targetDiv.length > 0) {
                            ...
                            // عملکرد گزینه ویرایش
                            $(".edit").on("click", function () {
                                var q = $("#hiddeninput2").val();
                                alert("q = " + q);
                                var y = targetDiv.find(".m1").text();
                                alert("y = " + y);
                                $(".text").text(y);
...
// <<<<<<<<<<<<<<<----------------
        ...
        $("#sendMessage").click(function () {
            ...
            if (hi2 == "") {
                ...
                var contactid = hi2;
                alert("contactidmmmmmmmmmm = " + contactid);
